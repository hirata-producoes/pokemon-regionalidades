...
- O executável agora mede 17.642.802 bytes (aproximadamente 16,83 MiB), o pacote com 10.485 entradas mede 15.420.832 bytes (aproximadamente 14,71 MiB), `data/sound_data.o` caiu para aproximadamente 0,35 MiB, `src/tilesets.o` mede aproximadamente 0,06 MiB e `src/tileset_anims.o` mede aproximadamente 0,07 MiB no PC.
